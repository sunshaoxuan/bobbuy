...
```pseudo
// 后端逻辑
Print(I18n("ERR_USER_NOT_FOUND"));
return Error(I18n("ERR_USER_NOT_FOUND"), "USER_NOT_FOUND");

// 界面逻辑
<span>{I18n("BTN_SAVE_SUCCESS")}</span>
ShowMessage(I18n("MSG_OPERATION_COMPLETED"));
```
