...
- 当前源码已把高危依赖解析版本提升到 `tomcat-embed-core 10.1.54`、`netty-transport 4.1.132.Final`、`commons-fileupload 1.6.0`；新的 GitHub-hosted dependency-check 复扫仍待生成，本地复扫继续受 `www.cisa.gov` DNS 不可达阻塞。
