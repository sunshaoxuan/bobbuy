...
- 已新增 AI sample golden 基线 `docs/fixtures/ai-onboarding-sample-golden.json`、对比脚本 `scripts/verify-ai-onboarding-samples.ps1` 与专项报告 `docs/reports/REPORT-03-AI商品字段识别样例验证报告.md`，用于真实视觉链路专用环境复核。
