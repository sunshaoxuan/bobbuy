...
- `.github/workflows/codeql.yml` 当前已恢复 `push` / `pull_request` / `workflow_dispatch`；最新成功 run 为 <https://github.com/sunshaoxuan/bobbuy/actions/runs/25177727147>，但默认分支 push 分析与 code scanning alert 数仍待下一轮归档。
