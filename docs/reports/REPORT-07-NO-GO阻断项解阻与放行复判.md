...
**提交**: `62ddb16109eb471b4886b4a82407f443342115c1`
...
**复判**: CodeQL 已从“无法运行”推进到“矩阵可成功执行”；但默认分支 push 分析与 alert 数仍需在下一个 `main` push 后重新归档。
...
| CodeQL 默认分支证据 | BLOCKED | 需在恢复后的 `push` 触发下重新产出默认分支 analysis，并补录 code scanning alerts 数 | 仓库管理员 / 安全负责人 |
